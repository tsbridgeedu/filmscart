            ...
            _main: function(e) {
                ...
                !(function(t) {
                    ...
                    if (
                        (ae(t),
                            ne(t),
                            "string" == typeof t.backdrop ? (w().style.background = t.backdrop) : t.backdrop || z([document.documentElement, document.body], _["no-backdrop"]), !t.backdrop && t.allowOutsideClick && R('"allowOutsideClick" parameter requires `backdrop` parameter to be set to `true`'),
                    ...
                    t.showCloseButton ? (c.setAttribute("aria-label", t.closeButtonAriaLabel), K(c)) : F(c),
                        ...
                        ie(t),
                        te(t),
                        G(t.footer, u), !0 === t.animation ? W(e, _.noanimation) : z(e, _.noanimation),
